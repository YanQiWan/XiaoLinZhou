...
public class Login extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==jp1_jb1)
		{
			...
			{
				try {
					FriendInterface.getFriendInterface(u.getQQId());//产生好友列表
	...
	private static void doShutDownWork() {  
        ...
        run.addShutdownHook(new Thread(){ //注册新的虚拟机来关闭钩子  
            ...
            public void run() {  
        		...
        		try {
        			oos = new ObjectOutputStream(ConnectSockets.linktoserver.getSocket().getOutputStream());
        			send_m.setSender(FriendInterface.ownerId);
