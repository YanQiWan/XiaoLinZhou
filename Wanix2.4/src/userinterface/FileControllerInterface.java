...
public class FileControllerInterface extends JFrame implements ActionListener, MouseListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == jb[0]) {
			...
			{
				Object[] obj={"OK"};
				JOptionPane.showOptionDialog(null, "您未选中任何文件", "错误", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, obj, obj[0]);
			}
			...
			{
				Object[] obj={"OK"};
				JOptionPane.showOptionDialog(null, "您选中的是目录！不可用此方式删除", "错误", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, obj, obj[0]);
			}
			...
			{
				Object[] obj={"OK"};
				JOptionPane.showOptionDialog(null, "您未选中任何目录", "错误", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, obj, obj[0]);
			}
			...
			{
				Object[] obj={"OK"};
				JOptionPane.showOptionDialog(null, "您选中的是文件！不可用此方式删除", "错误", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, obj, obj[0]);
			}			
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getClickCount()==2)
		{
			...
			{
				File file=filelist.get(i);
				if(file.getInode().getFilename().equals((String)((JLabel)e.getSource()).getText().substring(5)))
				{
					selectedfile=file;
					break;
				};
